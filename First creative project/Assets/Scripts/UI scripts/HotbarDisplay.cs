...
public class HotbarDisplay : StaticInventoryDisplay
{
    ...
    [SerializeField] private GameObject[] _hotbarSlotNumber;
    ...
    protected override void OnEnable()
    {
        ...
        _playerControls.Player.MouseWheel.performed += UseItem;
    }
    ...
    {
        for (int i = 0; i < _hotbarSlotNumber.Length; i++)
        {
            _hotbarSlotNumber[i].SetActive(true);
            _hotbarSlotNumber[i].GetComponent<TextMeshProUGUI>().text = (i + 1).ToString();
        }
        _hotbarSlotNumber[9].SetActive(true);
        _hotbarSlotNumber[9].GetComponent<TextMeshProUGUI>().text = "0";
    }
}
