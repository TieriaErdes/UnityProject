...
public class Quest : ScriptableObject
{
    ...
    public abstract class QuestGoal: ScriptableObject
    {
        ...
        public virtual string GetDescriotion()
        {
            return Description;
        }
        ...
        public void Skip()
        {
            // Нужно будет начислить игроку штрафные баллы
            Complete();
        }
    }
    ...
    {
        Completed = Goals.All(_goal => _goal.Completed);
        if (Completed)
        {
            // Нужно будет начислить игроку баллы в качестве награды за квест
